...
import org.firstinspires.ftc.teamcode.ftc6078.drive.Drive_Mecanum_Tele;
...
public class TeleOp2020 extends LinearOpMode {
    ...
    double boostSpeed = 2; // Speed multiplier for BOOSTING (1 being 100% of power going in)
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            // All gamepad values have been negated due to weirdness of controller
