package org.firstinspires.ftc.teamcode.ftc6078.Control;
...
public class Provider2020 {
  ...
  /*  public Rev2mDistanceSensor flightFront0;
    ...
    private void init_map(HardwareMap hMap){    // setup the hardware map dependant classes (usually by grabbing their components out of the hardware map)
        ...
        driveFL = mainMap.get(DcMotor.class, "front_left_motor"); // change back to driveFL for real code
        driveFR = mainMap.get(DcMotor.class, "front_right_motor"); // change back to driveFR for real code
        driveBL = mainMap.get(DcMotor.class, "back_left_motor"); // change back to driveBL for real code
        driveBR = mainMap.get(DcMotor.class, "back_right_motor"); // change back to driveBR for real code
